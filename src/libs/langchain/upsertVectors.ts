...
export async function upsertVectors(restaurantId: number, data: RestaurantData) {
  ...
  console.log(`Vectors for restaurant ${restaurantId} upserted to Pinecone via LangChain.`);
}
