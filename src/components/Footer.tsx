...
const classes = {
  footer:
    "px-6 md:px-20 lg:px-24 w-full text-sm text-slate-500 bg-white pt-16 border-t border-slate-100",
  ...
  brandIconContainer:
    "w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition-colors",
  ...
  sectionTitle:
    "font-semibold mb-2 text-gray-900 uppercase tracking-wider text-xs",
  sectionLink: "hover:text-indigo-600 transition-colors flex items-center",
  badge:
    "text-[10px] font-bold text-white bg-orange-600 rounded-full ml-2 px-2 py-0.5",
  newsletterSection: "",
  newsletterTitle:
    "font-semibold text-gray-900 mb-4 uppercase tracking-wider text-xs",
  ...
  input:
    "w-full bg-slate-50 border border-slate-200 focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none py-2.5 pl-10 pr-3 rounded-lg transition-all",
...
const FOOTER_DATA = {
  brand: {
    name: "RestaurantHub",
    description:
      "Empowering restaurant owners with cutting-edge management tools and expert industry insights to scale your business.",
  },
  sections: [
    {
      title: "Company",
  ...
  newsletter: {
    ...
    description:
      "The latest news and operational resources, sent to your inbox weekly.",
    ...
    <footer className={classes.footer}>
      <div className={classes.grid}>
        ...
        <div className={classes.brandSection}>
          <Link href="/" className={classes.brandLink}>
            ...
            <span className={classes.brandText}>{FOOTER_DATA.brand.name}</span>
          </Link>
      ...
      <div className={classes.bottomBar}>
        <p className={classes.copyright}>
          ...
          <span className={classes.copyrightBrand}>
