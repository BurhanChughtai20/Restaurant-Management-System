  ...
  return (
    <div className={`relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center`}>
      ...
      <div className="absolute inset-y-0 right-0 h-full w-px bg-linear-to-b from-gray-900 via-gray-800 to-gray-900 dark:bg-neutral-800/80">
        <div className="absolute h-40 w-px bg-linear-to-b from-gray-900 via-gray-800 to-gray-900" />
      </div>
      <div className={`absolute inset-x-0 bottom-0 h-px w-full `}>
        <div className="absolute mx-auto h-px w-40 bg-linear-to-b from-gray-900 via-gray-800 to-gray-900" />
      </div>
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <DynamicContent key={index} as="p" className={`text-base md:text-lg`}>
         ...
         <motion.div
          ...
          className="relative z-10 mt-4 flex flex-wrap items-center justify-center gap-5"
        >
