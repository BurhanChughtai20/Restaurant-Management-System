  ...
  const userData = useMemo(() => {
    if (!uiState.mounted)
      return {
        ...
        role: "",
        email: "",
        initial: UI_STRINGS.DEFAULT_INITIAL,
      };
    ...
    <StyledDrawer variant="permanent" open={uiState.open} component="aside">
      <Box
        sx={{
          display: "flex",
          alignItems: "center",
          justifyContent: uiState.open ? "space-between" : "center",
          p: 2,
        }}
      >
        {uiState.open && (
          <Stack direction="row" spacing={1.5} alignItems="center">
            <Box
              sx={{
                bgcolor: DRAWER_THEME.COLORS.ACCENT,
                borderRadius: 1.5,
                p: 0.6,
                display: "flex",
              }}
            ...
            <Typography
              variant="h6"
              fontWeight={800}
              sx={{ color: DRAWER_THEME.COLORS.ACCENT }}
              noWrap
            >
              {userData.name}
            </Typography>
      ...
      <Stack
        ...
        sx={{
          p: 2,
          borderTop: `1px solid ${DRAWER_THEME.COLORS.FOOTER_LINE}`,
          alignItems: "center",
          gap: 1.5,
          bgcolor: DRAWER_THEME.COLORS.BG,
        }}
      >
        <Avatar
          sx={{
        ...
        {uiState.open && (
          <>
            ...
            <IconButton size="small" onClick={handleMenuAction}>
