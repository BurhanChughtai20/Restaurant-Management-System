...
const classes = {
  ...
  buttonSecondary: "bg-transparent shadow-none dark:text-white",
  buttonDark: "bg-black text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
  buttonGradient: "bg-gradient-to-b from-blue-500 to-blue-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
};
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        classes.navBody,
        visible && classes.navBodyVisible,
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        classes.mobileNav,
        visible && classes.mobileNavVisible,
        className,
      )}
    >
      {children}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    dark: classes.buttonDark,
    gradient: classes.buttonGradient,
  };

  return (
    <Tag
      href={href || undefined}
      className={cn(classes.buttonBase, variantStyles[variant], className)}
      {...props}
    >
      {children}
    </Tag>
